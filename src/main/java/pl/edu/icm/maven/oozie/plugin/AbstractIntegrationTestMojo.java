...
public abstract class AbstractIntegrationTestMojo extends AbstractOozieMojo {
	...
	protected void initializeFieldsUsingEnvPropertiesFile()
		...
		String itEnvPropertiesLocation = OoziePluginConstants.IT_ENV_PROPERTIES_LOCATION
				.replaceAll(
		...
		hdfsWfWorkingDir = envConf
				.getProperty(OoziePluginConstants.HDFS_WF_WORKING_DIR);
